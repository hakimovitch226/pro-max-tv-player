...
export default function RootLayout({
  ...
  const whatsappNumber = '12096768909'
  const whatsappMessage = encodeURIComponent('Bonjour Pro Max Tv')
      ...
      <body className={inter.className}>
        ...
        <a
          ...
          onMouseEnter={e => {
            ...
            ;(e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 6px 16px rgba(0,0,0,0.4)'
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLAnchorElement).style.transform = 'scale(1)'
            ;(e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 4px 12px rgba(0,0,0,0.3)'
          }}
        >
          <svg
